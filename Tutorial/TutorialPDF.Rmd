...
```{r hist2, echo=FALSE}
library(tidyverse)
traits <-  mutate(traits, log.ht = log(height))
...
**R-squared (R2)** *quantifies the  amount of variation in the dependent variable that can be explained by independent variables in a regression model. It is calculated as: variation explained by model/total variation.*
